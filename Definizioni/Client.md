dispositivo o un programma che richiede servizi da un [[Server]]. In un'architettura [[Client-Server]], i client sono responsabili di inviare richieste ai server e di ricevere le risposte.
