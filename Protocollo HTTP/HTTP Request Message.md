Questo tipo di messaggio viene inviato da un client, come un browser web, a un server web per richiedere una risorsa specifica, come una pagina web, un file o un servizio.
